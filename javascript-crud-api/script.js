document.addEventListener("DOMContentLoaded", function () {
        ...
        comment.comments.forEach((data) => {
          data1 += `
            <div class="comment" data-id="${data.id}">
              ...
              <input class="body-input" type="text" name="post-comments"  readonly value="comment: ${data.body}">
  ...
  function appendComment(comment) {
    ...
    commentContainer.innerHTML = `
      ...
      <input type="text" class="body-input" name="post-comments" value="comment: ${comment.body}">
